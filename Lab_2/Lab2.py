...
def select_bubble(L,k):
    ...
    #If k is a negative value
        ...
        print("The first element in position", str(0)+" is,", str(L[0])+".")
        return L[0]
...
if __name__ == '__main__': 
    ...
    print()
    print()
    print("Unsorted list:", L3)
    print("----------------------- Modified Quick Sort -----------------------")
    print()
    select_modified_quick(L3,0)
    print()
    print()
    print()
    print("----------------------------- Part 2 ------------------------------")
    ...
    print()
    print()
    print("Unsorted list:", L5)
    print("----------------- While-Loop Modified Quick Sort ------------------")
    print()
    while_modified_quick(L5,0)
    print()