...
if __name__ == "__main__":
    ...
    filepath = 'C:/Users/Issac/Desktop/Lab_5/123.txt'
    testpath = 'C:/Users/Issac/Desktop/Lab_5/testz.txt'
    ...
    #If the user want to create a Hash Table with Linear Probing
        ...
        print("'6' for The largest ascii value of the string")
        ...
        if ans == 3:
            ...
            with open(filepath,  encoding="utf8") as fp:
                for line in fp:
                    count += 1
            T = HTLP.HashTableLP(int(count*1.5), ans2)
            counter = 0
            with open(filepath,  encoding="utf8") as fp:
                for line in fp:
                    word, emb = lineSplit(line)
        ...
        #If the user want to create a Hash Table with Chaining
            ...
            T = HTC.HashTableChain(15000, ans2)
            counter = 0
            with open(filepath,  encoding="utf8") as fp:
                for line in fp:
                    word, emb = lineSplit(line)
